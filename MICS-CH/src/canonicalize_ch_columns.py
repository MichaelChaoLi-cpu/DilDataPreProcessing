"""
Build rule-based canonical CH column metadata from translated labels.

Input:  MICS-CH/data/CH/translate/{dataset}/ch.yaml
Output: MICS-CH/data/CH/canonical/{dataset}/ch.yaml
"""
...
from canonical_ch import canonicalize_label
...
LOG_FILE = _MICS_CH_DIR / "logs" / "canonicalize_ch.log"
...
def main() -> None:
    ...
    translate_paths = sorted(TRANSLATE_DIR.rglob("ch.yaml"))
    if args.dataset:
    ...
    for translate_yaml_path in translate_paths:
        ...
        out_yaml_path = CANONICAL_DIR / dataset_name / "ch.yaml"
