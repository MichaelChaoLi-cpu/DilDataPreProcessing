"""
Build cross-questionnaire CH alignment from canonical variables.

Input:
  data/CH/canonical/{dataset}/ch.yaml

Outputs:
  data/CH/alignment_v2.yaml
  data/CH/alignment_summary_v2.csv
"""
...
CANONICAL_DIR = _MICS_CH_DIR / "data" / "CH" / "canonical"
OUT_FILE      = _MICS_CH_DIR / "data" / "CH" / "alignment_v2.yaml"
OUT_CSV       = _MICS_CH_DIR / "data" / "CH" / "alignment_summary_v2.csv"
LOG_FILE      = _MICS_CH_DIR / "logs" / "align_ch_v2.log"
...
def main() -> None:
    ...
    parser.add_argument("--include-review", action="store_true",
                        help="include low-confidence fallback variables")
    args = parser.parse_args()

    canonical_paths = sorted(CANONICAL_DIR.rglob("ch.yaml"))
    ...
    logger.info("DONE variables=%d output_yaml=%s output_csv=%s",
                len(alignment), OUT_FILE, OUT_CSV)
