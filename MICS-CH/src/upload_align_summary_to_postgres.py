"""
Upload CH alignment summary to PostgreSQL (localhost:5432, database: mda).

Table created (drop + recreate):
  align_summary_CH_MICS  -- variable coverage summary from alignment_summary_v2.csv
...
CSV_FILE = _MODULE_DIR / "data" / "CH" / "alignment_summary_v2.csv"
TABLE = "align_summary_CH_MICS"
