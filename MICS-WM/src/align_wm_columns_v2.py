"""
Build cross-questionnaire WM alignment from canonical variables.

Input:
  data/WM/canonical/{dataset}/wm.yaml

Outputs:
  data/WM/alignment_v2.yaml
  data/WM/alignment_summary_v2.csv
"""
...
CANONICAL_DIR = _MICS_WM_DIR / "data" / "WM" / "canonical"
OUT_FILE      = _MICS_WM_DIR / "data" / "WM" / "alignment_v2.yaml"
OUT_CSV       = _MICS_WM_DIR / "data" / "WM" / "alignment_summary_v2.csv"
LOG_FILE      = _MICS_WM_DIR / "logs" / "align_wm_v2.log"
...
def main() -> None:
    ...
    canonical_paths = sorted(CANONICAL_DIR.rglob("wm.yaml"))
