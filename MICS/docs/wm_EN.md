...
| Metric | Value |
|--------|-------|
| Total rows | 2,842,815 |
| Total columns | 7,678 |
| Countries/areas covered | 155 |
| Rounds covered | MICS2 – MICS6 |

The **wm module** (Women's Questionnaire) — One row per woman aged 15–49. Key topics: interview info, birth date and age, education, summary birth history (CM*), contraception (CP*), maternal health (MN*).

---

## 2. Distribution by Round

![Round overview](../etc/wm/fig1_round_overview_en.png)
...
![Country-round coverage](../etc/wm/fig2_coverage_en.png)
...
![Missing rate](../etc/wm/fig3_missing_en.png)

| Variable | Description | Missing Rate |
|----------|-------------|-------------|
| WM7 | Result of interview | 42.0% |
| WM9 | Age | 20.1% |
| WM10 | Ever attended school | 86.9% |
| WM11 | Highest level of education | 62.0% |
| CM1 | Ever given birth | 22.9% |
| CEB | Children ever born | 29.5% |

---

## 5. Age Distribution (MICS6)

![Age distribution](../etc/wm/fig4_age_en.png)
...
- **Link keys**: `country` + `mics_round` + HH1 + HH2 + LN (woman's line number)
