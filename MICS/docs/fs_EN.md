...
| Total rows | 475,521 |
| Total columns | 1,848 |
| Countries/areas covered | 66 |
| Rounds covered | MICS2 – MICS6 |

The **fs module** (Foundational Skills Module (Children 7–14)) — One row per child aged 7–14. Key topics: literacy, numeracy, foundational learning skills (FS*), cognitive development (CB*). Present in MICS5 and MICS6 only.

---

## 2. Distribution by Round

![Round overview](../etc/fs/fig1_round_overview_en.png)
...
![Country-round coverage](../etc/fs/fig2_coverage_en.png)
...
![Missing rate](../etc/fs/fig3_missing_en.png)

| Variable | Description | Missing Rate |
|----------|-------------|-------------|
| FS9 | Result of interview | 3.2% |
| FS5 | Age | 1.2% |
| FS6 | Sex | 0.0% |
...
![Age distribution](../etc/fs/fig4_age_en.png)
