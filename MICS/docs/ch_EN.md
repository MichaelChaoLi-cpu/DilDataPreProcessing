...
| Metric | Value |
|--------|-------|
| Total rows | 1,665,101 |
| Total columns | 6,074 |
| Countries/areas covered | 155 |
| Rounds covered | MICS2 – MICS6 |

The **ch module** (Under-5 Children's Questionnaire) — One row per child under 5. Key topics: interview info, birth date and age, birth registration (BR*), vaccination (VA*), ARI, diarrhoea (CA*), nutrition (AN*).

---

## 2. Distribution by Round

![Round overview](../etc/ch/fig1_round_overview_en.png)
...
![Country-round coverage](../etc/ch/fig2_coverage_en.png)
...
![Missing rate](../etc/ch/fig3_missing_en.png)

| Variable | Description | Missing Rate |
|----------|-------------|-------------|
| UF9 | Result of interview | 15.4% |
| UF4 | Sex | 21.6% |
| UF11 | Age | 45.6% |
| BR1 | Has birth certificate | 13.9% |
| BR2 | Registered | 60.6% |
...
- **Link keys**: `country` + `mics_round` + HH1 + HH2 + LN (child's line number)
