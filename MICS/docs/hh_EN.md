...
![Round overview](../etc/hh/fig1_round_overview_en.png)
...
![Country-round coverage](../etc/hh/fig2_country_round_coverage_en.png)
...
![Missing rate](../etc/hh/fig3_missing_rate_en.png)

| Variable | Description | Missing Rate |
|----------|-------------|-------------|
| HH6  | Area (urban/rural) | 12.7% |
| HH9  | Result of HH interview | 10.3% |
| HH11 | Number of household members | 38.9% |
| HC2  | Number of sleeping rooms | 27.8% |
| HC3  | Main material of floor | 14.8% |
| WS1  | Main source of drinking water | 11.5% |
...
![HH6 distribution](../etc/hh/fig4_hh6_urban_rural_en.png)
