"""
Questionnaire-level duplicate and overlap checks based on canonical HH variables.
...
LOG_FILE = _MICS_HH_DIR / "logs" / "dedup_v2.log"
...
def main() -> None:
    ...
    for canonical_yaml_path in canonical_paths:
        ...
        try:
            ...
            logger.info(
                "DONE dataset=%s records=%d groups=%d duplicate_candidate=%d duplicate_needs_review=%d derived_overlap=%d",
                dataset_name,
                stats["records"],
                stats["groups"],
