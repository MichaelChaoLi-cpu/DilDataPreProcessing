...
Usage:
  python upload_hh_to_postgres.py
"""
...
PARQUET_FILE = DATA_DIR / "HH" / "processed_data" / "hh_merged.parquet"
LOG_FILE = _MICS_HH_DIR / "logs" / "upload_hh.log"
...
def _copy_upload(conn, cur, table: str, df: pd.DataFrame) -> None:
    """Upload df to an already-created table using COPY for speed."""
