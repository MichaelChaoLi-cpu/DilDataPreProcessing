"""
Build cross-questionnaire HL alignment from canonical variables.

Input:
  data/HL/canonical/{dataset}/hl.yaml

Outputs:
  data/HL/alignment_v2.yaml
  data/HL/alignment_summary_v2.csv
"""
...
OUT_FILE      = _MICS_HL_DIR / "data" / "HL" / "alignment_v2.yaml"
OUT_CSV       = _MICS_HL_DIR / "data" / "HL" / "alignment_summary_v2.csv"
LOG_FILE      = _MICS_HL_DIR / "logs" / "align_hl_v2.log"
